        ...
        <div className="content">
          ...
          <div className="pricing-title">
            <h1>
              ...
              <br />
              <span className="your">your</span> needs.
            </h1>
            <h2 className="subtitle">
              Internshark can be used for free. Pro members gain access to
              additional features and premium resources, unlocking the full
              potential of Internshark.{" "}
            </h2>
          </div>
